...
|   Serveur Web   |   web    | 192.168.122.30 | www.cyber.lab<br>crl.cyber.lab |
| Client Windows  |    -     |      DHCP      |               -                |
___
...
Précédement nous avions généré la clé privée du serveur web dans `/etc/ssl/lab/private` et les CSR dans `/etc/ssl/lab/webserver.csr`. Maintenant nous allons transférer ce CSR sur le SubCA et émettre le certificat du serveur web :
...
# Tranfert du certificat et de la chaîne de confiance sur le Serveur WEB
...
I
![Pasted image 20260312101209](../../Images/Pasted%20image%2020260312101209.png)
...
![Pasted image 20260312102146](../../Images/Pasted%20image%2020260312102146.png)
...
L'OCSP Responder a pour rôle d'assurer la vérification en tant réel du statut d'un certificat. Ce dernier signe ces réponses pour empêcher une attaque de Man In The Middle. 
...
![Pasted image 20260315095846](../../Images/Pasted%20image%2020260315095846.png)

![Pasted image 20260315095804](../../Images/Pasted%20image%2020260315095804.png)
___

#### **Test de révocation**

Nous allons maintant révoquer le certificat du serveur WEB depuis le SubCA et regénérer le CRL :
...
![Pasted image 20260312111709](../../Images/Pasted%20image%2020260312111709.png)
...
Une **PKI privée**, quant à elle, est celle disposant d'une **CA** généré par une organisation pour ses activités propres. Le Root CA ici n'est pas inclut dans les Trusts Store.
